...
---------------------------------------------------------
INSERT INTO stp.u_provider (providername, authtype, authconfig, tokenconfig) VALUES
('AWS S3', 'OAuth2', '{"region":"us-east-1","bucket":"tree-photos"}', '{}'),
('Google Cloud Storage', 'OAuth2', '{"project":"tree-project","bucket":"tree-images"}', '{}'),
('Azure Blob Storage', 'OAuth2', '{"account":"treeproject","container":"photos"}', '{}');
...
---------------------------------------------------------
INSERT INTO stp.u_donor (donorname, mobilenumber, city, emailaddr, country, birthdt, propertylist, useridn, ts) VALUES
('Robert Anderson', '+1-555-1001', 'Seattle', 'robert.anderson@email.com', 'USA', '1985-03-15', '{"donor_level":"gold","preferences":"oak,pine"}', 2, '2024-03-01 10:00:00'),
('Emily Chen', '+1-555-1002', 'San Francisco', 'emily.chen@email.com', 'USA', '1990-07-22', '{"donor_level":"platinum","preferences":"all"}', 2, '2024-03-05 14:30:00'),
('David Kumar', '+91-98765-43210', 'Mumbai', 'david.kumar@email.com', 'India', '1988-11-10', '{"donor_level":"silver","preferences":"mango,eucalyptus"}', 3, '2024-03-10 09:15:00'),
('Maria Garcia', '+34-612-345-678', 'Madrid', 'maria.garcia@email.com', 'Spain', '1992-05-30', '{"donor_level":"gold","preferences":"cedar,oak"}', 3, '2024-03-15 16:45:00'),
('James Wilson', '+44-7700-900123', 'London', 'james.wilson@email.com', 'UK', '1983-09-18', '{"donor_level":"bronze","preferences":"birch,maple"}', 4, '2024-03-20 11:20:00'),
('Lisa Thompson', '+1-555-1003', 'Portland', 'lisa.thompson@email.com', 'USA', '1995-12-05', '{"donor_level":"silver","preferences":"pine,willow"}', 4, '2024-03-25 13:00:00'),
('Ahmed Hassan', '+20-100-123-4567', 'Cairo', 'ahmed.hassan@email.com', 'Egypt', '1987-04-25', '{"donor_level":"gold","preferences":"eucalyptus"}', 5, '2024-04-01 10:30:00'),
('Sophie Dubois', '+33-6-12-34-56-78', 'Paris', 'sophie.dubois@email.com', 'France', '1991-08-14', '{"donor_level":"platinum","preferences":"oak,cedar"}', 5, '2024-04-05 15:15:00');
...
---------------------------------------------------------
INSERT INTO stp.u_treephoto (treeidn, uploadts, photolocation, propertylist, fileidn, photots, donoridn, useridn) VALUES
(1, '2024-04-16 10:00:00', ST_GeogFromText('POINT(-122.3325 47.6065)'), '{"quality":"high","camera":"iPhone 13"}', 1, '2024-04-15 14:30:00', 1, 2),
(2, '2024-04-16 10:05:00', ST_GeogFromText('POINT(-122.3328 47.6068)'), '{"quality":"high","camera":"iPhone 13"}', 2, '2024-04-15 14:35:00', 1, 2),
(3, '2024-04-17 14:30:00', ST_GeogFromText('POINT(-122.3330 47.6070)'), '{"quality":"medium","camera":"iPhone 13"}', 3, '2024-04-16 16:00:00', 1, 2),
(4, '2024-04-22 11:00:00', ST_GeogFromText('POINT(-122.3335 47.6075)'), '{"quality":"high","camera":"Samsung S21"}', 4, '2024-04-20 15:20:00', 2, 2),
(7, '2024-05-11 09:15:00', ST_GeogFromText('POINT(-122.4198 37.7752)'), '{"quality":"high","camera":"Samsung S21"}', 5, '2024-05-10 13:45:00', 2, 2),
(8, '2024-05-11 09:20:00', ST_GeogFromText('POINT(-122.4200 37.7755)'), '{"quality":"medium","camera":"Samsung S21"}', 6, '2024-05-10 13:50:00', 2, 2),
(9, '2024-03-26 16:00:00', ST_GeogFromText('POINT(72.8780 19.0763)'), '{"quality":"high","camera":"OnePlus 9"}', 7, '2024-03-25 11:20:00', 3, 3),
(10, '2024-03-27 10:30:00', ST_GeogFromText('POINT(72.8783 19.0766)'), '{"quality":"high","camera":"OnePlus 9"}', 8, '2024-03-25 11:25:00', 3, 3),
(12, '2024-06-16 13:45:00', ST_GeogFromText('POINT(-3.7040 40.4170)'), '{"quality":"high","camera":"Google Pixel 6"}', 9, '2024-06-15 14:30:00', 4, 3),
(20, '2024-06-21 15:20:00', ST_GeogFromText('POINT(-3.7046 40.4176)'), '{"quality":"excellent","camera":"Canon EOS R5"}', 10, '2024-06-20 16:00:00', 8, 5);
