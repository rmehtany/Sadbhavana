...
--   Stored in: core.U_Control with ControlName = 'donor_update_high_water_mark'
-- =====================================================================================

CREATE OR REPLACE PROCEDURE stp.p_get_donor_update(
...
BEGIN
    ...
    SELECT COALESCE((core.F_GetControl('donor_update_high_water_mark')->>'idn')::INT, 0)
...
CREATE OR REPLACE PROCEDURE stp.p_post_donor_update(
    IN      P_AnchorTs      TIMESTAMPTZ,
    IN      P_UserIdn       INT,
    IN      P_RunLogIdn     INT,
    IN      p_InputJson     JSONB,
